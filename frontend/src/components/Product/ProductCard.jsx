...
const ProductCard = ({ product, onView, onEdit, onDelete }) => {
  ...
  return (
    <article
      className="product-card h-full flex flex-col bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 cursor-pointer overflow-hidden"
    ...
    >
      ...
      <div className="flex-1 flex flex-col p-6" role="presentation">
